                    ...
                    <form @submit.prevent="createAd" class="col-span-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="w-full rounded-md py-2 px-2.5 border-0 text-gray-900 ring-1 ring-inset ring-gray-300 focus:none" id="exampleFormControlInput2" required
                                   ...
                                   <div v-if="validationErrors.description" class="text-red-500">{{ validationErrors.description }}</div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput3" class="block text-sm mb-2">Price</label>
                            <input type="number"  class="w-full rounded-md py-2 px-2.5 border-0 text-gray-900 ring-1 ring-inset ring-gray-300 focus:none" id="exampleFormControlInput3" required
                                   v-model="ad.price">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput4" class="block text-sm mb-2">Photos</label>
                            <input type="file" multiple accept="image/*" class="py-2" id="exampleFormControlInput4" ref="file" @change="handlePhotosChange" />
