      ...
      <div class="my-5">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-3 md:gap-3 mt-5">
          <div class="flex flex-col col-span-2 rounded-lg  bg-white p-5">
            <div>
              <div v-if="getAd && getAd.all_photos && getAd.all_photos.length > 0" class="carousel h-96 w-full">
                <div
                ...
                >
                  ...
                  <div class="absolute flex justify-between transform -translate-y-1/2 left-2 right-2 top-1/2">
                    <button @click="prev()" class="btn bg-white p-2 px-4 rounded-full border border-black">❮</button>
                    <button @click="next()" class="btn bg-white p-2 px-4 rounded-full border border-black">❯</button>
                  </div>
                </div>
              </div>
